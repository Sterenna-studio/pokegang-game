...
const TRAINER_TYPES = {
  ...
  gold:           { fr:'Éthan',          en:'Ethan',          sprite:'ethan-gen2',     diff:7, reward:[6000,12000], rep:50},
  ...
  kindler:         { fr:'Allumeur',       en:'Kindler',        sprite:'kindler-gen3',      diff:2, reward:[25,70],    rep:3  },
  parasollady:     { fr:'Dame Ombrelle',  en:'Parasol Lady',   sprite:'parasollady',       diff:2, reward:[30,85],    rep:3  },
  triathlete:      { fr:'Triathlète',     en:'Triathlete',     sprite:'triathletebikerm-gen3', diff:2, reward:[30,80],    rep:3  },
  triathletebikerf:{ fr:'Triathlète♀',   en:'Triathlete♀',    sprite:'triathletebikerf-gen3', diff:2, reward:[30,80],    rep:3  },
  ...
  crasherwake:     { fr:'Vague',          en:'Crasher Wake',   sprite:'crasherwake',       diff:4, reward:[2500,5000], rep:20 },
