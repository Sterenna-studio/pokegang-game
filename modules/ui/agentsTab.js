...
function renderAgentsTab() {
  ...
  html += `<div class="agent-card-full" id="btnRecruitAgentFull"
    style="display:flex;align-items:center;justify-content:center;cursor:pointer;min-height:120px;
           border:2px dashed var(--gold-dim);transition:box-shadow .15s"
    onmouseenter="this.style.boxShadow='0 0 12px rgba(255,204,90,.2)'"
    onmouseleave="this.style.boxShadow=''">
    <div style="text-align:center">
      <div style="font-family:var(--font-pixel);font-size:9px;color:var(--gold)">
        ★ RECRUTEMENT ★
      </div>
      <div style="font-size:9px;color:var(--gold);margin-top:5px">
