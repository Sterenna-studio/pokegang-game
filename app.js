...
function playAutoCombatVisual(...args)                              { return globalThis._zwin_playAutoCombatVisual(...args); }
...
function startGameLoop() {
  ...
  Scheduler.register('vivariumSync',    vivariumSyncTick,    TICK_VIVARIUM_SYNC_MS, { skipWhenHidden: false });
